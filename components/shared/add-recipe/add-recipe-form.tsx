...
export const AddRecipeForm = () => {
    ...
    >([]);
    const [categoriesSelectLoading, setCategoriesSelectLoading] =
    ...
    return (
        <>
            <FormSelect
                ...
                required
            />
            <FormInput name="recipeName" label="Название рецепта" required />
            <FormInput
                name="servings"
                label={"Порции"}
                type="number"
                ...
                required
            />
            <FormTextarea name="fullDescription" label="Описание приготовления" />
                        ...
                        <div className="flex justify-between flex-wrap gap-2">
                            ...
                            <div className="flex gap-2 px-2">
                                ...
                                <Button
                                    ...
                                    style={{
                                        visibility:
                                            index !== fields.length - 1 ? "hidden" : "visible",
                                    }}
                                    type="button"
                                >
                                    <Plus size={16} />
